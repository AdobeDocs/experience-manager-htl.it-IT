...
Mentre ci sono diversi modi per incorporare una classe Java con HTL, il più semplice è quello di estendere il `WCMUsePojo` classe. Per il nostro esempio `/apps/my-example/component/info/Info.java`:
