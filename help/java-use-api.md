...
Ci sono diversi modi per incorporare una classe Java con HTL, ma quello più semplice consiste nell’estendere la classe `WCMUsePojo`. Per il nostro esempio `/apps/my-example/component/info/Info.java`:
