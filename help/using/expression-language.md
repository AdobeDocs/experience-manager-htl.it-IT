...
Traduce la stringa nella lingua del file di *origine* corrente (vedi sotto), utilizzando il [dizionario](https://experienceleague.adobe.com/docs/experience-manager-65/developing/components/internationalization/i18n-translator.html?lang=it) corrente. Se non viene trovata alcuna traduzione, viene utilizzata la stringa originale.
